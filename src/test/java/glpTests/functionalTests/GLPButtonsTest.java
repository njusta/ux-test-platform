...
public class GLPButtonsTest extends BaseClass {
    ...
    public Object[][] getAllButtonsCSSPropsTestData() {
        return new Object[][]{
    ...
    private void verifyAllButtonsCSSPropsTest(String type, String btnType, String[] expColor, String[] expBgColor, String[] expHeight, String expBorRad, String expTextDecoration) throws Exception {
    ...
    @Test(testName = "Verify Default Buttons Border Test", dataProvider = "Default Button Border Test Data", groups = "desktop-regression")
    private void verifyDefaultButtonBorderTest(String type, boolean hover, String btnType, String expStyle, String[] expColor, String expWidth) throws Exception {
        String[] detailsPropertiesList = new String[]{"elementId", "button-target", "componentName", "Button"};
        String[] propsPropertiesList = new String[]{"btnType", btnType, "children", type};
        setConfigAndLaunch(detailsPropertiesList, propsPropertiesList);
    ...
    @Test(testName = "Verify Default Button -Disabled Test", groups = {"desktop-regression"})
    ...
    @Test(testName = "Verify Button -Hover state Test", dataProvider = "Button-Hover and Focus state Test Data", groups = {"desktop-regression"})
    private void buttonHoverStateTest(String type, String btnType, String action, String[] expColor, String[] expBgColor) throws Exception {
        if (browser.equals("safari") || browser.equals("firefox") || browser.equals("ie")) {
    ...
    private void incorrectValuesLoadingIndicatorTest(String elemId, String compName, String btnType) throws Exception {
    ...
    @Test(testName = "Mobile : Verify All Buttons CSS Props Test", dataProvider = "All Buttons CSS Props Test Data", groups = "mobile-regression")
    private void verifyAllButtonsCSSPropsMobileTest(String type, String btnType, String[] expColor, String[] expBgColor, String[] expHeight, String expBorRad, String expTextDecoration) throws Exception {
        String[] detailsPropertiesList = new String[]{"elementId", "button-target", "componentName", "Button"};
        String[] propsPropertiesList = new String[]{"btnType", btnType, "children", type};
        setConfigAndLaunch(detailsPropertiesList, propsPropertiesList);
    ...
    @Test(testName = "Mobile : Verify Default Buttons Border Test", dataProvider = "Default Button Border Test Data", groups = "mobile-regression")
    private void verifyDefaultButtonBorderMobileTest(String type, boolean hover, String btnType, String expStyle, String[] expColor, String expWidth) throws Exception {
        if (hover) {
            throw new SkipException("Hover operation not yet supported in firefox/safari browser drivers");
        }
        String[] detailsPropertiesList = new String[]{"elementId", "button-target", "componentName", "Button"};
    ...
    @Test(testName = "Mobile : Verify Default Button -Disabled Test", groups = {"mobile-regression"})
    ...
    private void incorrectValuesLoadingIndicatorMobileTest(String elemId, String compName, String btnType) throws Exception {
        String[] detailsPropertiesList = new String[]{"elementId", elemId, "componentName", compName};
        String[] propsPropertiesList = new String[]{"btnType", btnType, "children", btnType + " button'"};
        setConfigAndLaunch(detailsPropertiesList, propsPropertiesList);
