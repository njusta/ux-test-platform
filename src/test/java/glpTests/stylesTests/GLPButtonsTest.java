...
public class GLPButtonsTest extends BaseClass {
    ...
    private void verifyDefaultButtonBorderTest(String type, boolean hover, By elem, String expStyle, String[] expColor, String expWidth) {
        if (hover) {
    ...
    @Test(testName = "Verify Default Button Test-Disabled Test", groups = {"desktop-regression"})
    ...
    @Test(testName = "Verify Link Button -Hover state Test", dataProvider = "Link Button-Hover state Test Data", groups = {"desktop-regression"})
    ...
    @Test(testName = "Mobile : Verify All Buttons CSS Props Buttons Test", dataProvider = "All Buttons CSS Props Test Data", groups = "mobile-regression")
    private void verifyAllButtonsCSSPropsMobileTest(String type, By elem, String[] expColor, String[] expBgColor, String[] expHeight, String expBorRad, String expTextDecoration) {
    ...
    private void verifyDefaultButtonBorderMobileTest(String type, boolean hover, By elem, String expStyle, String[] expColor, String expWidth) {
        if (hover) {
